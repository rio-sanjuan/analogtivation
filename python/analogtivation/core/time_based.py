...
def seasonal_activation(x: Union[np.ndarray, float], 
                       hemisphere: str = "northern") -> Union[np.ndarray, float]:
    """
...
class SeasonalActivation(TimeBasedActivation):
    ...
    def __init__(self, hemisphere: str = "northern", use_local_time: bool = True):
        ...
        super().__init__("seasonal", hemisphere=hemisphere, use_local_time=use_local_time)
